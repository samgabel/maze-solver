...
class Maze:
    ...
    # NOTE: When we break the walls to create the maze, we break them in a way that suits the solving method to prioritize going right and down first
    ...
    def solve(self):
        """
        Solve our randomly generated maze using DFS
        """
